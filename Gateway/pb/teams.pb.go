...
const file_teams_proto_rawDesc = "" +
	"\n" +
	"\vteams.proto\x12\tanalytics\x1a\x1bgoogle/protobuf/empty.proto\"J\n" +
	"\x06Member\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\x04R\x06userId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05admin\x18\x03 \x01(\bR\x05admin\"y\n" +
	"\x04Team\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12+\n" +
	"\amembers\x18\x04 \x03(\v2\x11.analytics.MemberR\amembers\"1\n" +
	"\bTeamList\x12%\n" +
	"\x05teams\x18\x01 \x03(\v2\x0f.analytics.TeamR\x05teams\"v\n" +
	"\x11CreateTeamRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12+\n" +
	"\amembers\x18\x03 \x03(\v2\x11.analytics.MemberR\amembers\"(\n" +
	"\x0eGetTeamRequest\x12\x16\n" +
	"\x06teamId\x18\x01 \x01(\tR\x06teamId\"+\n" +
	"\x11DeleteTeamRequest\x12\x16\n" +
	"\x06teamId\x18\x01 \x01(\tR\x06teamId\"T\n" +
	"\x11UpdateTeamRequest\x12\x16\n" +
	"\x06teamId\x18\x01 \x01(\tR\x06teamId\x12'\n" +
	"\x06update\x18\x02 \x01(\v2\x0f.analytics.TeamR\x06update\"R\n" +
	"\fTeamResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage2\xcc\x02\n" +
	"\vTeamService\x12C\n" +
	"\n" +
	"CreateTeam\x12\x1c.analytics.CreateTeamRequest\x1a\x17.analytics.TeamResponse\x125\n" +
	"\aGetTeam\x12\x19.analytics.GetTeamRequest\x1a\x0f.analytics.Team\x127\n" +
	"\bGetTeams\x12\x16.google.protobuf.Empty\x1a\x13.analytics.TeamList\x12C\n" +
	"\n" +
	"DeleteTeam\x12\x1c.analytics.DeleteTeamRequest\x1a\x17.analytics.TeamResponse\x12C\n" +
	"\n" +
	"UpdateTeam\x12\x1c.analytics.UpdateTeamRequest\x1a\x17.analytics.TeamResponseB(Z&analytics/internal/delivery/grpc/pb;pbb\x06proto3"
...
var file_teams_proto_goTypes = []any{
	(*Member)(nil),            // 0: analytics.Member
	(*Team)(nil),              // 1: analytics.Team
	(*TeamList)(nil),          // 2: analytics.TeamList
	(*CreateTeamRequest)(nil), // 3: analytics.CreateTeamRequest
	(*GetTeamRequest)(nil),    // 4: analytics.GetTeamRequest
	(*DeleteTeamRequest)(nil), // 5: analytics.DeleteTeamRequest
	(*UpdateTeamRequest)(nil), // 6: analytics.UpdateTeamRequest
	(*TeamResponse)(nil),      // 7: analytics.TeamResponse
	(*emptypb.Empty)(nil),     // 8: google.protobuf.Empty
}
var file_teams_proto_depIdxs = []int32{
	0, // 0: analytics.Team.members:type_name -> analytics.Member
	1, // 1: analytics.TeamList.teams:type_name -> analytics.Team
	0, // 2: analytics.CreateTeamRequest.members:type_name -> analytics.Member
	1, // 3: analytics.UpdateTeamRequest.update:type_name -> analytics.Team
	3, // 4: analytics.TeamService.CreateTeam:input_type -> analytics.CreateTeamRequest
	4, // 5: analytics.TeamService.GetTeam:input_type -> analytics.GetTeamRequest
	8, // 6: analytics.TeamService.GetTeams:input_type -> google.protobuf.Empty
	5, // 7: analytics.TeamService.DeleteTeam:input_type -> analytics.DeleteTeamRequest
	6, // 8: analytics.TeamService.UpdateTeam:input_type -> analytics.UpdateTeamRequest
	7, // 9: analytics.TeamService.CreateTeam:output_type -> analytics.TeamResponse
	1, // 10: analytics.TeamService.GetTeam:output_type -> analytics.Team
	2, // 11: analytics.TeamService.GetTeams:output_type -> analytics.TeamList
	7, // 12: analytics.TeamService.DeleteTeam:output_type -> analytics.TeamResponse
	7, // 13: analytics.TeamService.UpdateTeam:output_type -> analytics.TeamResponse
