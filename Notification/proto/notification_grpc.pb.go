...
type NotificationServiceClient interface {
	...
	GetUserNotifications(ctx context.Context, in *GetUserNotificationsRequest, opts ...grpc.CallOption) (*NotificationsList, error)
}
...
func (c *notificationServiceClient) GetUserNotifications(ctx context.Context, in *GetUserNotificationsRequest, opts ...grpc.CallOption) (*NotificationsList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type NotificationServiceServer interface {
	...
	GetUserNotifications(context.Context, *GetUserNotificationsRequest) (*NotificationsList, error)
...
func (UnimplementedNotificationServiceServer) GetUserNotifications(context.Context, *GetUserNotificationsRequest) (*NotificationsList, error) {
