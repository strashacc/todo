...
const (
	TeamService_CreateTeam_FullMethodName = "/analytics.TeamService/CreateTeam"
	TeamService_GetTeam_FullMethodName    = "/analytics.TeamService/GetTeam"
	TeamService_GetTeams_FullMethodName   = "/analytics.TeamService/GetTeams"
	TeamService_DeleteTeam_FullMethodName = "/analytics.TeamService/DeleteTeam"
	TeamService_UpdateTeam_FullMethodName = "/analytics.TeamService/UpdateTeam"
)
...
type TeamServiceClient interface {
	...
	GetTeams(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TeamList, error)
...
func (c *teamServiceClient) GetTeams(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TeamList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TeamList)
...
type TeamServiceServer interface {
	...
	GetTeams(context.Context, *emptypb.Empty) (*TeamList, error)
...
func (UnimplementedTeamServiceServer) GetTeams(context.Context, *emptypb.Empty) (*TeamList, error) {
...
func _TeamService_GetTeams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeamServiceServer).GetTeams(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "analytics.TeamService",
