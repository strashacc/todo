...
const file_task_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"task.proto\x12\tanalytics\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x8a\x03\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\tupdatedAt\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"1\n" +
	"\bTaskList\x12%\n" +
	"\x05tasks\x18\x01 \x03(\v2\x0f.analytics.TaskR\x05tasks\"\x93\x02\n" +
	...
	"\x06taskId\x18\x01 \x01(\x04R\x06taskId\"T\n" +
	"\x11UpdateTaskRequest\x12\x16\n" +
	"\x06taskId\x18\x01 \x01(\x04R\x06taskId\x12'\n" +
	"\x06update\x18\x02 \x01(\v2\x0f.analytics.TaskR\x06update\"w\n" +
	"\fTaskResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x04R\x02id\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12#\n" +
	"\x04task\x18\x04 \x01(\v2\x0f.analytics.TaskR\x04task2\xcc\x02\n" +
	"\vTaskService\x12C\n" +
	"\n" +
	"CreateTask\x12\x1c.analytics.CreateTaskRequest\x1a\x17.analytics.TaskResponse\x125\n" +
	"\aGetTask\x12\x19.analytics.GetTaskRequest\x1a\x0f.analytics.Task\x127\n" +
	"\bGetTasks\x12\x16.google.protobuf.Empty\x1a\x13.analytics.TaskList\x12C\n" +
	"\n" +
	"DeleteTask\x12\x1c.analytics.DeleteTaskRequest\x1a\x17.analytics.TaskResponse\x12C\n" +
	"\n" +
	"UpdateTask\x12\x1c.analytics.UpdateTaskRequest\x1a\x17.analytics.TaskResponseB(Z&analytics/internal/delivery/grpc/pb;pbb\x06proto3"
...
var file_task_proto_goTypes = []any{
	(*Task)(nil),                  // 0: analytics.Task
	(*TaskList)(nil),              // 1: analytics.TaskList
	(*CreateTaskRequest)(nil),     // 2: analytics.CreateTaskRequest
	(*GetTaskRequest)(nil),        // 3: analytics.GetTaskRequest
	(*DeleteTaskRequest)(nil),     // 4: analytics.DeleteTaskRequest
	(*UpdateTaskRequest)(nil),     // 5: analytics.UpdateTaskRequest
	(*TaskResponse)(nil),          // 6: analytics.TaskResponse
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 8: google.protobuf.Empty
}
var file_task_proto_depIdxs = []int32{
	7,  // 0: analytics.Task.deadline:type_name -> google.protobuf.Timestamp
	7,  // 1: analytics.Task.createdAt:type_name -> google.protobuf.Timestamp
	7,  // 2: analytics.Task.updatedAt:type_name -> google.protobuf.Timestamp
	0,  // 3: analytics.TaskList.tasks:type_name -> analytics.Task
	7,  // 4: analytics.CreateTaskRequest.deadline:type_name -> google.protobuf.Timestamp
	0,  // 5: analytics.UpdateTaskRequest.update:type_name -> analytics.Task
	0,  // 6: analytics.TaskResponse.task:type_name -> analytics.Task
	2,  // 7: analytics.TaskService.CreateTask:input_type -> analytics.CreateTaskRequest
	3,  // 8: analytics.TaskService.GetTask:input_type -> analytics.GetTaskRequest
	8,  // 9: analytics.TaskService.GetTasks:input_type -> google.protobuf.Empty
	4,  // 10: analytics.TaskService.DeleteTask:input_type -> analytics.DeleteTaskRequest
	5,  // 11: analytics.TaskService.UpdateTask:input_type -> analytics.UpdateTaskRequest
	6,  // 12: analytics.TaskService.CreateTask:output_type -> analytics.TaskResponse
	0,  // 13: analytics.TaskService.GetTask:output_type -> analytics.Task
	1,  // 14: analytics.TaskService.GetTasks:output_type -> analytics.TaskList
	6,  // 15: analytics.TaskService.DeleteTask:output_type -> analytics.TaskResponse
	6,  // 16: analytics.TaskService.UpdateTask:output_type -> analytics.TaskResponse
